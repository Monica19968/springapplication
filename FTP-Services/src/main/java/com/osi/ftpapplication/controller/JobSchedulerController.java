...
public class JobSchedulerController {
	 ...
	 */
	/// From UI, PostMan
	@PostMapping("/createJobSchedular")
	...
	public String runSchedular(@PathVariable Integer id
			) throws IOException, SftpException {
		jobSchedulerService.runJobSchedular(id);
		return "jobScheduled sucessfully";
	}
