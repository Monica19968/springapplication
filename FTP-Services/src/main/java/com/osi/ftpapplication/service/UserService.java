...
public class UserService {
	...
	public User isValidUser(String username) throws InvalidUserException, UsernameNotFoundException {
		Optional<User> user = userRepository.findByUserName(username);
		User ans = user.get();
		if(ans.getUserName().equalsIgnoreCase("admin") && ans.getPassword().equalsIgnoreCase("admin"))
			return ans;
		else
